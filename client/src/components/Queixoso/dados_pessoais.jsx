...
const UseForm = ({ data, updateFielHndler }) => {
    ...
    return (
        <>
            ...
            {novoTrabalhador ? (
                <h3 className="h3-cTrabalhador"> Olá, <span className="span-cTrabalhador"> {novoTrabalhador.Pessoa.nome + " " + novoTrabalhador.Pessoa.sobrenome}</span></h3>
            ) : (
                <div>
                    <div class="card">
                                ...
                                <Col md={6}>
                                    <Form.Group>
                                        ...
                                        <Form.Control
                                            ...
                                            name="password"
                                            value={data.password || ""}
                                            onChange={(e) => updateFielHndler("password", e.target.value)}
                                        />
                                    </Form.Group>
                                </Col>
                            </Row>
