        ...
        <>
            ...
            {data.empresa2 != "outra" ? (
                <div>
                    ...
                    {
                        data.empresa2 === "outra" ? (
                            <button type='button' className='btn fw-bold bg-link btn-new-empresa' onClick={() => setFormEmpresa(true)}>
                                <FaPlus /><span>Nova Empresa</span>
                ...
                <div class="card">
                    <button type='button' className='btn fw-bold bg-warning' onClick={selectEmpresaagain}>
