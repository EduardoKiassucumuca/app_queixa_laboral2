...
console.log(props.queixa.assunto)
    ...
    function editar_queixa(id,novo_assunto,novo_facto,novo_modo) {
        axios.put('http://localhost:3001/editar_queixa', {
            params: {
                id_queixa: id,
    ...
    return (
        <>
            ...
            >
                ...
                <Modal.Footer><Button onClick={(e) => update_view()} variant='warning'>OK</Button>
                </Modal.Footer>
            </Modal>
            <MDBModal tabIndex='-1' show={props.show} setShow={props.setShow}>
                <MDBModalDialog centered>
                    <MDBModalContent>
                        ...
                        <MDBModalBody>
                            <Row className="mb-3">
                                ...
                                {/*<p className='file-Contrato'>
                                    <a href={props.server} id='url-contrato-pdf' download>
                        ...
                        <MDBModalFooter>
                            <Button variant='warning' onClick={criar_historico}> Editar</Button>
                        </MDBModalFooter>
