...
const UseForm = ({ data, updateFielHndler }) => {
    ...
    const verificaBI = (e) => {
        ...
        try {
            ...
            var trabalhador_encontrado = trabalhadores.filter(trabalhador => trabalhador.numeroBI == e.target.value)
            /*trabalhadores.forEach(function getBI(trabalhador) {
                if (trabalhador.numeroBI === e.target.value) {
                    setEmployee(trabalhador.pessoa)
            ...
            setEmployee(trabalhador_encontrado[0].Pessoa)
            setfoundEmployee(true);
                ...
                <Form.Group>
                    ...
                    <>
                        ...
                        <Alert key="success" variant="success">
                            Trabalhador
                            <Alert.Link href="#"> {employee.nome + " " + employee.sobrenome}</Alert.Link> Já se encontra registrado!
