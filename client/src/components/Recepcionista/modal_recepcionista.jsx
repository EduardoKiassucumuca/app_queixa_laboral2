...
const ModalRecepcionista = (props) => {
  ...
  if (JSON.stringify(props.queixa) === "{}") {
    ...
    nome_trabalhador =
      props.queixa.Trabalhador.Pessoa.nome +
      " " +
      props.queixa.Trabalhador.Pessoa.sobrenome;
      ...
      <MDBModal tabIndex="-1" show={props.show} setShow={props.setShow}>
        <MDBModalDialog centered>
          <MDBModalContent>
            ...
            <MDBModalBody>
              <p className="texto-entidade">Assunto : {assunto}</p>
              <p className="texto-entidade">Facto : {facto}</p>
              ...
              <p className="texto-entidadeEmpregadora">Estado: {estado}</p>
              <p className="nota">Nota: {nota}</p>
            </MDBModalBody>
            <MDBModalFooter>
              <Button onClick={props.close} variant="warning">
                {" "}
                OK
              </Button>
            </MDBModalFooter>
